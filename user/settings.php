...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'update_profile') {
        ...
        try {
            ...
            if ($user['first_login'] == 1 && $faculty_name !== 'New User') {
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-4">
                    <div class="flex flex-col items-center mb-4">
                        <div class="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center text-4xl font-bold text-white shadow-lg mb-3">
                        ...
                        <span class="mt-2 px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs font-semibold">
                            <i class="bi bi-person-fill"></i> Faculty Member
                        </span>
                    </div>
                    ...
                    <div class="space-y-3 border-t pt-4">
                        ...
                        <?php if ($user['first_login'] == 1): ?>
                            <div class="mt-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                                <p class="text-xs font-semibold text-orange-800 flex items-center gap-2">
                                    <i class="bi bi-exclamation-triangle-fill"></i>
                                    Account Setup Required
                                </p>
                                <p class="text-xs text-orange-700 mt-1">
                                    Please update your profile and change your password to complete setup.
                                </p>
                                <?php if ($user['account_expires_at']): ?>
                                    <p class="text-xs text-orange-600 mt-2 font-semibold">
                                        <i class="bi bi-clock"></i> Expires: <?= date('M d, g:i A', strtotime($user['account_expires_at'])) ?>
                                    </p>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
        ...
        <div class="lg:col-span-2 space-y-4">
                ...
                <form method="POST" class="p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="faculty_name" value="<?= htmlspecialchars($user['faculty_name']) ?>"
                               ...
                               required>
                        <p class="text-xs text-gray-500 mt-1">Your complete name as it should appear in tickets</p>
                    </div>
                    ...
                    <?php if ($user['first_login'] == 1): ?>
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-3 rounded mb-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-semibold text-blue-800 text-sm">First Time Setup</p>
                                    <p class="text-xs text-blue-700 mt-1">Please update your name from "New User" to your actual name to complete your profile setup.</p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <form method="POST" class="p-4">
                    ...
                    <?php if ($user['first_login'] == 1): ?>
                        <div class="bg-orange-50 border-l-4 border-orange-400 p-3 rounded mb-4">
                            <div class="flex items-start">
                                <i class="bi bi-exclamation-triangle-fill text-orange-600 mr-2 mt-0.5"></i>
                                <div>
                                    <p class="font-semibold text-orange-800 text-sm">Password Change Required</p>
                                    <p class="text-xs text-orange-700 mt-1">You must change your default password (ncitad1234) to activate your account and prevent it from being disabled.</p>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded mb-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-yellow-700 mt-1">Use a strong password with at least 6 characters. Include letters, numbers, and symbols for better security.</p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="current_password"
                               ...
                               required>
                        <?php if ($user['first_login'] == 1): ?>
                            <p class="text-xs text-gray-500 mt-1">Current password: <strong>ncitad1234</strong></p>
                        <?php endif; ?>
                    </div>
